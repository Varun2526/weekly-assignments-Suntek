...
// return (
//     <div>
//         <h2 class="text-9xl bg-amber-500 text-center "> Welcome to React!</h2>
//         <h2>username: {username}</h2>
//         <h2>Phone Number: {person.pno}</h2>
...
// return(
//     <div className="text-left grid xl:grid-cols-3 mx-7 my-6 p-2  gap-4 ">
//         {products.map((product)=>(
//           <Product productObj={product} key={products.id}/> 
//         ))}
//         {/* without map |
//                         |
